...
class Urls {
  ...
  static String getCancledTasks = '$_baseUrl/listTaskByStatus/${TaskStatus.Cancelled.name}';
  static String getCompleatedTasks = '$_baseUrl/listTaskByStatus/${TaskStatus.Completed.name}';
